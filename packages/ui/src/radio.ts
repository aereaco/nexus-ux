            ...
            return {
                init() {
                    ...
                    this.$nextTick(() => {
                        ...
                        while (walker.nextNode()) (walker as any).currentNode.setAttribute('role', 'none')
                    })
                },
                __value: undefined,
                __active: undefined,
                __rootEl: this.$el,
                __optionValues: [] as any,
                ...
                __isFirstOption(option: any) {
                    return this.__optionValues.indexOf(option) === 0
                },
                __setActive(option: any) {
                    this.__active = option
                },
                __focusOptionNext() {
                    let option = this.__active
                    let all = this.__optionValues.filter((i: any) => !this.__disabledOptions.has(i))
