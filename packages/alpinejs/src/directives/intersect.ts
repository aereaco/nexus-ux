export default function (Alpine: any) {
    Alpine.directive('intersect', Alpine.skipDuringClone((el: any, { value, expression, modifiers }: any, { evaluateLater, cleanup }: any) => {
...
function getThreshold(modifiers: any[]) {
...
export function getRootMargin(modifiers: any[]) {
    const key = 'margin'
