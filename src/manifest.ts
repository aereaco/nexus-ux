...
import * as mod_58 from './modules/modifiers/self.ts';
import * as mod_59 from './modules/modifiers/stop.ts';
import * as mod_60 from './modules/modifiers/throttle.ts';
import * as mod_61 from './modules/modifiers/window.ts';
import * as mod_62 from './modules/modifiers/zoom.ts';
export const autoModifiers: any[] = [  { name: 'debounce', module: mod_50 },
  ...
  { name: 'self', module: mod_58 },
  { name: 'stop', module: mod_59 },
  { name: 'throttle', module: mod_60 },
  { name: 'window', module: mod_61 },
  { name: 'zoom', module: mod_62 }];
import * as mod_63 from './modules/listeners/bfcache.ts';
import * as mod_64 from './modules/listeners/executeScript.ts';
import * as mod_65 from './modules/listeners/history.ts';
import * as mod_66 from './modules/listeners/linkRewriter.ts';
export const autoListeners: any[] = [  { name: 'bfcache', module: mod_63 },
  { name: 'executeScript', module: mod_64 },
  { name: 'history', module: mod_65 },
  { name: 'linkRewriter', module: mod_66 }];
