...
// Swap minified -> non-minified bundle so stack traces have real names
await page.route('**/dist/nexus-ux.min.js', route =>
  route.fulfill({ path: '/home/aerea/development/nexus-ux/dist/nexus-ux.js', contentType: 'application/javascript' }));
const logs = [];
